                 ...
                 {onSync && (
                  ...
                  {onOpenStandalone && (
                    <button 
                      ...
                      className="h-[50px] w-12 flex items-center justify-center bg-[var(--color-surface-raised)] text-[var(--color-text-medium)] hover:text-white rounded-lg hover:bg-[var(--color-surface-raised-hover)] transition-colors active:scale-95" 
